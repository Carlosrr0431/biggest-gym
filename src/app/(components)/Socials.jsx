...
const Socials = () => {
  ...
  return <div className={`${pathname == '/cursos' || pathname == '/planes' || pathname == '/about' || cambioHeader ? 'hidden' : ''} flex gap-x-7 items-center justify-center`}>
    ...
    <Link href={'https://www.instagram.com/biggest.gym.online?igsh=Ym9jdzZmdnNocjI3'} target="_blank" className="duration-300 transition-all hover:scale-110  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85]"> <Image src={Instagram} width={20} height={20} alt="" /> </Link>
