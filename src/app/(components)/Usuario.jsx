    ...
    <tr className="">
      <td className="p-4 border-b border-blue-gray-50 text-white">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <p className="block font-sans text-sm antialiased font-normal leading-normal opacity-70 text-white">
              {elem.nombre}
            </p>
      ...
      <td className="p-4 border-b border-blue-gray-50">
        <div className="w-max">
          {elem.tipoPlan == "Plan x2" ? (
            elem.dias < 8 ? (
              <div className="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-green-500 uppercase rounded-md select-none whitespace-nowrap bg-green-500/20">
                <span className="">Activo</span>
              </div>
            ) : (
              <div className="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-red-800/20 text-red-800">
      ...
      <td className="p-4 border-b border-blue-gray-50">
        ...
        establecerFecha(elem.fechaPago) < 31 ? (
          <button
            onClick={async () => {
                ...
                toast.custom(
                  (t) => (
                    <div className="bg-white p-4 rounded-md text-black relative">
                      ...
                      <span className="text-green-800">{elem.nombre}</span> Ya
                      puede ingresar al Gym
                    </div>
                  ),
                  {
                    position: "top-center",
          ...
          <button
            ...
            className="relative  right-[5%] min-h-[50px]  min-w-[70px] select-none  font-sans text-xs font-medium uppercase  text-green-500 border-[1px]  rounded-md border-gray-200 p-2  transition-all hover:bg-gray-200/10 active:bg-gray-200/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none items-center text-center "
            type="button"
          >
            Ya ingreso{" "}
            <span className="relative border-l-[1px] border-gray-200 h-full py-4 px-1 text-center items-center"></span>{" "}
            <span className="text-white">{elem.horaIngreso}</span>
          </button>
        ) : elem.tipoPlan == "Plan x2" &&
          (establecerFecha(elem.fechaPago) >= 31 || elem.dias >= 8) ? (
          <button
            onClick={() => {
          ...
          >
            ...
            <span
              className={`text-white ${
                elem.ingreso == true ? "block mt-1" : "hidden"
              }`}
            >
              {elem.horaIngreso}
            </span>
        ...
        establecerFecha(elem.fechaPago) < 31 ? (
          ...
          (establecerFecha(elem.fechaPago) >= 31 || elem.dias >= 12) ? (
          <button
            onClick={() => {
              setShowModal2(true),
                setInfo({
        ...
        establecerFecha(elem.fechaPago) < 31 ? (
          ...
          (establecerFecha(elem.fechaPago) >= 31 || elem.dias >= 31) ? (
          <button
            onClick={() => {
              setShowModal2(true),
                setInfo({
