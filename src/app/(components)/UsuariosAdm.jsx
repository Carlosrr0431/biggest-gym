...
export const UsuariosAdm = () => {
    ...
    return (
        ...
        <div className="relative flex flex-col w-[80%] h-full text-gray-700  bg-clip-border   ">
            <div className="mr-10 relative overflow-hidden text-gray-700 rounded-none bg-clip-border ">
                <div className="flex mx-8 my-2 items-center justify-between gap-8 mb-8">
                    <div>
                        <h5
            ...
            <div className="p-6 px-0 overflow-scroll h-auto">
